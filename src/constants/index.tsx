...
export const skillText = [
    {
        ...
        desc: "I try hard to create a great product and user experience." +
            " It's not about luck, it's about trying and engrossing ourselves in order to achieve success." +
            " I know that my efforts and passion create our opportunities."
    },
    {
        title: "The harder you try, the more opportunities you get.",
        desc: "Luck doesn't simply happen by chance; " +
            "it's created through our passion and effort." +
            " To find opportunities, we must dedicate ourselves to what we love and are passionate about." +
            " Even when we become tired along the way, if we persist and keep striving, we will inevitably find the path and direction we seek." +
            " Luck is something we craft for ourselves through hard work and dedication."
    },
    {
        title: "Valuable knowledge is the best investment.",
        desc: "\"Valuable knowledge is the best investment\" emphasizes that cultivating knowledge is the most reliable and valuable investment. By building knowledge, you can create future opportunities and achieve personal growth. Knowledge is a treasure that you can carry around for a lifetime."
    }
]
